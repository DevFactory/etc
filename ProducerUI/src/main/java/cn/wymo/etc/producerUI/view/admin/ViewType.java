package cn.wymo.etc.producerUI.view.admin;
...
import cn.wymo.etc.producerUI.view.site.UserProfileNavigationManager;
...
public enum ViewType {
	...
	PROFILE  ("profile",   "我", UserProfileNavigationManager.class,     FontAwesome.USER);
